        ...
        return (
            <nav id="nav-container">
                ...
                <div className="nav-column">
                    ...
                    <Link className="nav-g" onClick={this.showDetail.bind(this,"02")}>信息查询</Link>                
                    <div id="02" className="nav-d" style={{ display: 'none' }} data-show='true'>
                        <Link to='/basicQuery' className="nav-d-c">基础信息查询</Link>    
                    </div>
                    <Link className="nav-g" onClick={this.showDetail.bind(this,"03")}>个人信息</Link>                
                    ...
                    <Link className="nav-g" onClick={this.showDetail.bind(this,"04")}>薪酬福利</Link>                
                    <div id="04" className="nav-d" style={{ display: 'none' }} data-show='true'>
                        <Link to='/attBrowse' className="nav-d-c">福利查询</Link>    
                    </div>
                    <Link className="nav-g" onClick={this.showDetail.bind(this,"05")}>公司概况</Link>                
                    ...
                    <div id="07" className="nav-d" style={{ display: 'none' }} data-show='true'>
                        <Link className="nav-d-c" onClick={this.openWeSite}>招聘网站</Link>    
                        {/* <Link to='/home' className="nav-d-c">招聘网站</Link>     */}
                    </div>
                </div>            
